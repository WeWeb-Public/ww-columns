    ...
    computed: {
        ...
        wrap() {
            return {
                ...
                sm: {
                    flexWrap: this.wwObject.content.data.config.sm.nowrap ? "nowrap" : "wrap"
                },
                md: {
                    flexWrap: this.wwObject.content.data.config.md.nowrap ? "nowrap" : "wrap"
                },
                lg: {
                    flexWrap: this.wwObject.content.data.config.lg.nowrap ? "nowrap" : "wrap"
                }
            };
        }
    },
